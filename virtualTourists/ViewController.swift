...
class ViewController: UIViewController, MKMapViewDelegate{
    ...
    func loadPinData() {
        ...
        do {
            let pins = try stack.viewContext.fetch(fetchRequest)
    ...
    func mapView(_ mapView: MKMapView, didSelect view: MKAnnotationView) {
        ...
        controller = self.storyboard?.instantiateViewController(withIdentifier: "photoViewController") as! photoViewController
